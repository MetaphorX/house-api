...
const connectWallet= ({propertyDetails:{price,rentFrequency,rooms,title,agency}}) =>{

}


const PropertyDetails = ({propertyDetails:{price,rentFrequency,rooms,title,baths,area,agency, isVerified, description, type,furnishingStatus, amenities,photos} })=>(
    <Box maxWidth="1000px" margin="auto" p="4">
      ...
      {amenities.length && <Text fontSize='2xl' fontWeight='black' marginTop='5'>Amenities:</Text>}
        ...
        <Flex flexWrap="wrap" w="full" borderTop="2px" marginTop="3" borderColor="gray">
            <Text fontSize="20" marginTop="3">Want Apartment?</Text>
            <Button
